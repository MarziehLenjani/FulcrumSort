...
int main(int argc, char **argv)
{
	...
	//locShiftAmt = ceil(log2(elemPerSubarray));
	//cout << "Location shift amount: " << locShiftAmt << endl;
...
//		cout << endl << endl;
		...
		u64 rowPerBankForHist = ceil(1.0 * G_NUM_HIST_ELEMS * 4 / G_NUM_BYTES_IN_ROW);
#endif
		...
		for(radixStartBit = 0; radixStartBit < G_KEY_BITS; radixStartBit += G_RADIX_BITS){
			...
			radixSortMask = (1UL << radixEndBit) - (1UL << radixSortShift);
...
//				}
				...
				u64 maxProcessedElems = elemPerSubarray;
