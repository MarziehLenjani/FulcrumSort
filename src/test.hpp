...
class tests{
public:
	bool runTestByTestNumber(CONF_TEST_NUMBER_TYPE testNumber, stackedMemory *stackedMemoryObj ){
...
//	}
	...
	bool testDataPartitioningAddressTranslation(stackedMemory *stackedMemoryObj ){
		bool testSuccess=false;
	...
	bool testBroadcasting(stackedMemory *stackedMemoryObj ){
		bool testSuccess=false;
