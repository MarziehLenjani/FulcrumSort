...
void configAndStats::parseOptions(int argc, char **argv) {
    desc.add_options()   ("help", "produce help message")
			(CONF_TEST_NUMBER_NAME,po::value<CONF_TEST_NUMBER_TYPE>(&testNumber)->default_value(1), CONF_TEST_NUMBER_NAME) //TODO:
			...
			(CONF_NUMBER_OF_BANKS_PER_LAYER_NAME,po::value<CONF_NUMBER_OF_BANKS_PER_LAYER_TYPE>(&numBankInLayer)->default_value(64), "number of bnaks in a layer")
			(CONF_NUMBER_OF_COMPUTE_SUBARRAY_PER_BANK_NAME,po::value<CONF_NUMBER_OF_COMPUTE_SUBARRAY_PER_BANK_TYPE>(&numComputeSubarrayInABank)->default_value(64), "number of compute subarrays  in a bank")
